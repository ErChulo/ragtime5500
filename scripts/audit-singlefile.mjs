...
if (!/<script\b[^>]*\btype=["']module["'][^>]*\bnonce=["']ragtime5500-local-runtime-v1["'][^>]*>[\s\S]+<\/script>/i.test(html)) violations.push('compiled JavaScript is not inlined with the required CSP nonce');
